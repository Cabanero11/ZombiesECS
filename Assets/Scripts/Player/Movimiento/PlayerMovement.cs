...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void MovementStateHandler()
    {
        ...
        else if (Input.GetKey(crouchKey) && rb.velocity.magnitude <= walkSpeed && grounded && !OnSlope())
        {
    ...
    private void WallRunningMovement()
    {
        ...
        if (rb.velocity.magnitude >= wallRunSpeed)
        {
            ...
            Vector3 limitedVelocity = new Vector3(rb.velocity.x, 0f, rb.velocity.z).normalized * wallRunSpeed;
